 ...
 *         Date:  26.04.2016
 */
class KobaltRunConfigurationProducer : AbstractExternalSystemRunConfigurationProducer() {

    override fun getConfigurationFactory() = KobaltExternalTaskConfigurationType.getInstance().factory
